...
add(17,"Energy cell pack","","Bulk Cell")
add(2010,"Rocket")
add(2008,"Shotgun shells","Shotgun shells")
add(8,"Backpack")
ammo=(2007,2048,2046,2049,2047,17,2010,2008,8)
#keys
add(5,"Blue Keycard","","Key")
add(40,"Blue Skull Key","","Key")
add(13,"Red Keycard","","Key")
add(38,"Red Skull Key","","Key")
add(6,"Yellow Keycard","","Key")
add(39,"Yellow Skull Key","","Key")
